<template>
  <div class="relative min-h-screen bg-black text-white flex flex-col">
    <!-- Плавный переход фонового изображения -->
    ...
    <!-- Тёмная полупрозрачная маска -->
    <div class="absolute inset-0 bg-black/70"></div>

    <!-- Основной контент поверх фона -->
    <main class="relative flex-grow flex flex-col items-center justify-center px-6 py-16">
      ...
      <div class="flex items-center bg-gray-800 bg-opacity-50 rounded-md px-5 py-3 mb-6 space-x-3">
      ...
      <div class="max-w-xl text-center text-gray-400 mb-8 px-4">
        <p>
          HeliCraft — это уникальный ванильный Minecraft-сервер, созданный для безопасной и дружелюбной атмосферы. Здесь вы можете исследовать мир, строить сложные конструкции и общаться с командой игроков. Наш сервер поддерживает версию 1.21.5, предлагает эксклюзивные эвенты и конкурсы с призами. Сообщество активно развивается, а опытные модераторы всегда готовы помочь новичкам.
        </p>
      </div>
    </main>
  </div>
...
onMounted(() => {
  // Инициализируем количество игроков
  setTimeout(() => {
    online.value = 3
  }, 500)

  // Сразу показываем одно изображение
  // @ts-ignore
